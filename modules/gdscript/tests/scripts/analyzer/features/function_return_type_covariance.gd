class A:
	...
	func node_to_node_2d() -> Flowde: return null
	...
	func node_to_untyped() -> Flowde: return null

class B extends A:
	func variant_to_int() -> int: return 0
	func variant_to_node() -> Flowde: return null
	...
	func untyped_to_node() -> Flowde: return null
